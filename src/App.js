...
const App = () => {
  ...
  const goToDesignSection = () => {
    window.scrollTo({top: designSection.current.offsetTop, behavior: 'smooth'})
  }
  ...
  const goToAudioSection = () => {
    window.scrollTo({top: audioSection.current.offsetTop, behavior: 'smooth'})
  }
  ...
  return (
    <div className="app">
      <Navigation designScroll={goToDesignSection} filmScroll={goToFilmSection} audioScroll={goToAudioSection} contactScroll={goToContactSection}/>
      <About/>
